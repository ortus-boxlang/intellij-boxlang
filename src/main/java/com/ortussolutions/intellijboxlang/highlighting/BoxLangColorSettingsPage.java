...
public final class BoxLangColorSettingsPage implements ColorSettingsPage {
	...
	private static final AttributesDescriptor[] DESCRIPTORS = new AttributesDescriptor[] {
	    ...
	    new AttributesDescriptor( "Member function (default library)", BoxLangTextAttributes.MEMBER_FUNCTION ),
	    ...
	    new AttributesDescriptor( "Method call", BoxLangTextAttributes.METHOD_CALL ),
